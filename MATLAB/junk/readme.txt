...
================================
-CallTest 
-run_CallTest.sh (shell script for temporarily setting environment variables and 
                  executing the application)
   -to run the shell script, type
   
       ./run_CallTest.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v94, run the shell script as:
       ...
       ./run_CallTest.sh /mathworks/home/application/v94
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_CallTest.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/v94/runtime/glnxa64:MR/v94/bin/glnxa64:MR/v94/sys/os/glnxa64:MR/v94/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_CallTest.sh 
