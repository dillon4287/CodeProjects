function [sumFt, sumFt2, sumOM, sumOM2, sumST, sumST2,...
    ...
    burnin, ReducedRuns, initFactor, initobsmodel, initStateTransitions, v0, r0, s0,d0, identification, estML)
%% INPUT
% % yt is K x T
...
% [LogLikelihood, Fpriorstar, piFtstarGivenyAndthetastar]
...
% [fyGiventhetastar , priorST , priorObsVariance ,priorFactorVar , priorAstar ,posteriorStar]
