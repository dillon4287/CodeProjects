...
DataCell{1,6} = 0;
DataCell{1,7} = 0;
save('BigKow/kose_aer_rep_raw.mat', 'DataCell')
DataCell = cell(1,7);
...
DataCell{1,6} = 0;
DataCell{1,7} = 0;
save('BigKow/newmethod_only_constant.mat', 'DataCell')
DataCell = cell(1,7);
DataCell{1,1} = y(:,2:end);
DataCell{1,2} = X;
DataCell{1,3} = InfoCell;
...
DataCell{1,6} = 0;
DataCell{1,7} = 0;
save('BigKow/raw_data.mat', 'DataCell')
%%%%%%%%%%%%%%%%%%%%
kowdata = importRealData('~/GoogleDrive/Datasets/kow_march6.csv');
InfoCell{1,1} = [1,180];
InfoCell{1,2} = [1,9; 10,15; 16,69; 70,123; 124,144;145,162;163,180];
...
DataCell{1,6} = 0;
DataCell{1,7} = 0;
save('BigKow/kose_compare_standardized.mat', 'DataCell')
...
DataCell{1,6} = 0;
DataCell{1,7} = 0;
save('BigKow/kose_aer_rep_standardized.mat', 'DataCell')
...
DataCell{1,6} = 0;
DataCell{1,7} = 0;
save('BigKow/newmethod_only_constant_standardized.mat', 'DataCell')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
