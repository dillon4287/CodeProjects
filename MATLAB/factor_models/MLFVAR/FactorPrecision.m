function [P,H] = FactorPrecision(params, P0, factorPrecision, T)
...
H = full([spdiags(ones(nFactors*lags,1),0, nFactors*lags, nFactors*T);H]);
Sinv = spdiags(repmat(factorPrecision, T,1), 0, nFactors*T, nFactors*T);
