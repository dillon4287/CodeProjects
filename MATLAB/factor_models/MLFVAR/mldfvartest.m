...
[DataCell] = ...
    MLDFVARdata(T, Regions, CountriesInRegion,SeriesPerCountry,beta, gamma);

yt = DataCell{1,1};
Xt = DataCell{1,2};
InfoCell = DataCell{1,3};
InfoCell2 = DataCell{1,4};
Factor = DataCell{1,5};
Gamma = DataCell{1,7};
Gt = DataCell{1,8};
...
[sumFt, sumFt2,sumOM, sumOM2, sumST, sumST2,...
    ...
    MLDFVAR(yt, InfoCell, InfoCell2, Sims, burnin, ReducedRuns,  initFactor, initobsmodel, ...
